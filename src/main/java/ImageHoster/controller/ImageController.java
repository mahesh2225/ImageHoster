...
public class ImageController {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session,
        ...
        Boolean isLoggedUSer = sameOrDiffUserLoggedIn(image.getUser(), session);
    ...
    // This method is to check whether Logged in User and given user are same or not
    private Boolean sameOrDiffUserLoggedIn(User user, HttpSession session) { //need to change method name
