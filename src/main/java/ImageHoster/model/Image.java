...
public class Image {
    ...
    //The 'comments' table is mapped with 'users' table
    //cascade = CascadeType.REMOVE specifies that if a record in 'users' table is deleted, then all the records in 'comments' table associated  will be deleted first and then the record in the 'users' table will be deleted
    //FetchType is LAZY
