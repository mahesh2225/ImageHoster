...
public class Comment {
    ...
    // Text is a Postgres specific column type that allows to save text based data that will be longer than 256 characters
    ...
    // This attribute contains image
    // Since the mapping is Many to Many, a new table will be created with
    // two columns both referencing to the primary key of both the tables
    // ('images', 'comments')
